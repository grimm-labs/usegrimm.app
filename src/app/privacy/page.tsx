    ...
    <div className="flex flex-col justify-between min-h-screen">
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="bg-white p-6 md:p-12 max-w-4xl w-full">
          ...
          <p className="mb-6">
            Cookies are small files stored on your device to improve your experience with the Service. You can disable cookies
            in your browser settings, but doing so may limit some functionality of the Service.
          </p>

          <h2 className="text-xl font-semibold text-blue-600 mb-4">Security</h2>
          <p className="mb-6">
            We take the security of your Personal Information seriously and implement measures to protect it. However,
            no method of transmission over the Internet or electronic storage is completely secure.
          </p>

          <h2 className="text-xl font-semibold text-blue-600 mb-4">Your Rights</h2>
          <p className="mb-6">
            You have the right to access, correct, or delete your Personal Information. If required by law, you may also
            revoke consent for the use of your data. To exercise these rights, please contact us.
          </p>

          <h2 className="text-xl font-semibold text-blue-600 mb-4">Changes to This Privacy Policy</h2>
          <p className="mb-6">
            This Privacy Policy is effective as of December 22, 2024, and may be updated periodically. Changes will be
            posted here, and continued use of the Service constitutes acceptance of the updated policy.
          </p>

          <h2 className="text-xl font-semibold text-blue-600 mb-4">Contact Us</h2>
          <p>
            If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@usegrimm.app" className="text-blue-500 underline">support@usegrimm.app</a>.
          </p>
        </div>
      </div>
      <Footer />
