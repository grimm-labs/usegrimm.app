        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="text-center max-w-md">
            <h1 className="text-3xl font-bold text-gray-800 mb-4">
              {blogPostTranslations.notFound.title}
            </h1>
            <p className="text-gray-600 mb-6">
              {blogPostTranslations.notFound.description}
            </p>
            <Link
              href="/blog"
              className="inline-block bg-green-600 px-6 py-3 rounded-full text-white transition-colors hover:bg-green-700 font-medium"
            >
              {blogPostTranslations.notFound.backToBlog}
            </Link>
          </div>
        </div>
        <Footer />
